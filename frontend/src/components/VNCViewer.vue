<template>
  <div class="vnc-viewer-container">
    <!-- VNC Status Bar -->
    <div class="vnc-status-bar bg-slate-100 border-b border-slate-200 p-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="flex items-center gap-2">
            ...
            ></div>
            <span class="text-sm font-medium text-slate-700 text-slate-700">
              {{
                vncStatus.connected
                  ? 'VNC Connected'
                  : vncStatus.connecting
          ...
          <div v-if="vncStatus.error" class="text-xs text-red-600 text-red-600">
            {{ vncStatus.error }}
          </div>
        </div>
    ...
    <div class="vnc-content flex-1 relative">
      ...
      <div v-else class="flex items-center justify-center h-full">
        <div class="text-center">
          ...
          <h3 class="text-lg font-semibold text-slate-900 mb-2">VNC Desktop</h3>
    ...
    >
      <div class="bg-white bg-slate-100 rounded-lg p-6 max-w-4xl max-h-[90vh] overflow-auto">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-lg font-semibold text-slate-900">Screenshot</h3>
          <button @click="closeScreenshotModal" class="text-slate-500 hover:text-slate-700">
        ...
        <div v-if="currentScreenshot" class="text-center">
          <img
            ...
            alt="Screenshot"
            class="max-w-full max-h-[70vh] rounded border border-slate-200"
          />
